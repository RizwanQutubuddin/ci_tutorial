...
|
*/
$config['base_url'] = 'http://localhost/codeigniter/ci-tutorial/';
...
|
*/
$config['sess_driver'] = 'files'; //1. 'files' is used for store session in the system; 2.'database' 
$config['sess_cookie_name'] = 'ci_session';
$config['sess_samesite'] = 'Lax';
$config['sess_expiration'] = 7200;
$config['sess_save_path'] = null;   //1. 'C:\wamp64\www\sesstmt' set path for store location, default location is 'C:\wamp64\tmp'; 2.'ci_sessions' is table name
